def covid():
    ...
    days, healthy_history, sick_history, recovered_history, dead_history = simulate(
        places, n_healthy, n_sick, time_frame, initial_social_distancing, initial_vaccination, initial_travel_restri
    )
    ...
    slider_travel_restri = Slider(slider_ax_travel_restri, 'Travel Restriction', 0, 1, valinit=initial_travel_restri)
    ...
    def update_plot(val):
        ...
        days, healthy_history, sick_history, recovered_history, dead_history = simulate(
            places, n_healthy, n_sick, time_frame, social_distancing, vaccination, travel_restri
        )
